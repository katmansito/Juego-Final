...
public class PanelGalvez extends JPanel implements KeyListener {
    ...
    // ==== Constructor ====
    public PanelGalvez(boolean modoVersus, String marca1, String marca2) { // 👈 ahora recibe las marcas
        this.modoVersus = modoVersus;
        setFocusable(true);
        addKeyListener(this);

        galvez = new Galvez();
        limites = new LimitesCircuitos("src/imagenes/Limite_Galvez.png");
    ...
    private void actualizarAuto(Auto a) {
        // Actualiza posición guardando la anterior
    ...
    protected void paintComponent(Graphics g) {
        ...
        // === Luego aplicar zoom y transformaciones ===
        double x1 = auto.getX();
        double y1 = auto.getY();
        ...
        // === DIBUJAR CIRCUITO SOBRE EL FONDO VERDE ===
