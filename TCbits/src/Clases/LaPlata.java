...
public class LaPlata {

    private BufferedImage fondo;

    public LaPlata() {
        try {
            Image img = new ImageIcon(getClass().getResource("/imagenes/Trazado_LaPlata.png")).getImage();
            ...
            System.err.println("No se pudo cargar la imagen Trazado_LaPlata.png");
            e.printStackTrace();
        }
    }
    ...
    public void dibujar(Graphics g, int ancho, int alto) {
        if (fondo != null) {
            ...
            g.drawString("No se pudo cargar Trazado_LaPlata.png", 50, 50);
        }
    }
